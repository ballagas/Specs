...
# because the built framework isn't included in the repository
  s.source           = { :http => "https://dl.dropboxusercontent.com/u/21714253/CollabSDK/CollabSDK.frameworkv" + s.version.to_s + ".zip" }
  #s.source		= { :path => "." }
  ...
  #s.dependency 'Firebase', '~> 2.5' #commenting due to failed spec validation
  s.dependency 'SAMKeychain'
  s.dependency 'MBProgressHUD'
  s.dependency 'NSData+Base64'
  s.dependency 'Reachability'
  s.dependency 'AWSiOSSDKv2', '2.3.6'
